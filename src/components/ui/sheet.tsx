...
>(
  (
    { side = 'right', className, children, hideDefaultClose, ...props },
    ref
  ) => (
    <SheetPortal>
      <SheetOverlay />
...
>(({ className, ...props }, ref) => (
  <SheetPrimitive.Title
    ref={ref}
    className={cn(
      'text-slate-950 text-lg font-semibold dark:text-slate-50',
      className
    )}
    {...props}
  />
